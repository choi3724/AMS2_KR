...
- See [0.83.2 validation and reproduction](installer/0.83.2/VALIDATION.md) for test evidence and remaining runtime checks.
...
```powershell
powershell -ExecutionPolicy Bypass -File tools/repository/Build-InstallerOutsideRepo.ps1 -Version 0.83.2 -CompatibilityDataRoot E:\AMS2_Korean_Work\build\translation-halo-legacy-20260913-v1\data
```
