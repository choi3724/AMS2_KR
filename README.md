...
- See [0.85 validation and reproduction](installer/0.85/VALIDATION.md) for test evidence and remaining runtime checks.
...
```powershell
powershell -ExecutionPolicy Bypass -File tools/repository/Build-InstallerOutsideRepo.ps1 -Version 0.83.3 -CompatibilityDataRoot E:\AMS2_Korean_Work\build\hud-beta-help-legacy-20260914-v2\data
```
