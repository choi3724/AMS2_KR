...
namespace Ams2KoreanBeta
{
    ...
    {
        public const string PackageId = "AMS2-KR-BETA-0.6.84-PRETENDARD";
        public const string Version = "Closed Beta 0.6.84";
        ...
        public const long BffPatcherBytes = 72342057;
        public const string BffPatcherSha256 = "DB41713EFB5E17AF6F3A9B6098011CC2FAF7A2A77BD83437B7FC19B13B125922";
    ...
    internal sealed class BetaEngine
    {
        ...
        public OperationResult Diagnose(GameInfo game, string outputZip)
        {
            try
            {
                Prepare(game);
                ValidateGame(game);
                string temp = Path.Combine(Path.GetTempPath(), "AMS2-KR-BETA0684-DIAG-" + Guid.NewGuid().ToString("N"));
        ...
        private void PreflightFiles()
        {
            ...
            string tempRoot = Path.Combine(Path.GetTempPath(), "AMS2-KR-BETA0684-BFF-" + Guid.NewGuid().ToString("N"));
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (route.Equals("GUI\\kr13_driver_name_semibold.bfont", StringComparison.OrdinalIgnoreCase) ||
                        route.Equals("GUI\\kr13_font_hud_main.bfont", StringComparison.OrdinalIgnoreCase)) patchResidue = true;
        ...
        private void CleanupIgphaseHudCandidate()
        {
            ...
            try
            {
                ...
                if (directory.StartsWith(temp, StringComparison.OrdinalIgnoreCase) && Path.GetFileName(directory).StartsWith("AMS2-KR-BETA0684-BFF-", StringComparison.Ordinal))
