...
namespace Ams2KoreanBeta
{
    ...
    internal static class GameUpdateCompatibility
    {
        ...
        internal sealed class CompatibilityOutcome
        {
            ...
            public bool ShouldNotify { get { return UnknownBuild && BuildChanged || Reapplied > 0 || SkippedOptional > 0; } }
            public string Notice
            {
                get
                {
                    var lines = new List<string>();
                    if (UnknownBuild) lines.Add("새 게임 빌드 " + BuildId + "을 감지했습니다. 빌드 번호만으로 실행을 차단하지 않고 현재 파일 구조를 검사했습니다.");
