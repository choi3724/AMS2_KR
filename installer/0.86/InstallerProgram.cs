...
namespace Ams2KoreanBeta
{
    ...
    internal sealed class InstallerForm : Form
    {
        ...
        public InstallerForm()
        {
            ...
            Text = "Automobilista 2 한국어 패치 — Open Beta 0.86";
            Font = UiFont(9F);
        ...
        private Control BuildTitleBar()
        {
            ...
            Label title = new Label { Text = "Automobilista 2 한국어 패치 — Open Beta 0.86", ForeColor = TextPrimary, Font = UiFont(10.5F), TextAlign = ContentAlignment.MiddleLeft, Location = new Point(49, 0), Size = new Size(720, 43) };
        ...
        private Control BuildFooter()
        {
            ...
            Label version = new Label { Text = "Automobilista 2 한국어 패치 — Open Beta 0.86", ForeColor = Color.FromArgb(131, 118, 117), Font = UiFont(8.5F), TextAlign = ContentAlignment.MiddleRight, Anchor = AnchorStyles.Top | AnchorStyles.Right, Size = new Size(430, 37) };
        ...
        private Control BuildStatusCard()
        {
            ...
            card.Resize += delegate
            {
                ...
                int versionLeft = (int)Math.Round(card.ClientSize.Width * 0.868F);
