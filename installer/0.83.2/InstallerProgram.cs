...
namespace Ams2KoreanBeta
{
    ...
    internal sealed class InstallerForm : Form
    {
        ...
        public InstallerForm()
        {
            ...
            Text = "Automobilista 2 한국어 패치 — Open Beta 0.83.2";
            Font = UiFont(9F);
        ...
        private Control BuildTitleBar()
        {
            ...
            Label title = new Label { Text = "Automobilista 2 한국어 패치 — Open Beta 0.83.2", ForeColor = TextPrimary, Font = UiFont(10.5F), TextAlign = ContentAlignment.MiddleLeft, Location = new Point(49, 0), Size = new Size(720, 43) };
        ...
        private Control BuildFooter()
        {
            ...
            Label version = new Label { Text = "Automobilista 2 한국어 패치 — Open Beta 0.83.2", ForeColor = Color.FromArgb(131, 118, 117), Font = UiFont(8.5F), TextAlign = ContentAlignment.MiddleRight, Anchor = AnchorStyles.Top | AnchorStyles.Right, Size = new Size(430, 37) };
        ...
        private static Color StatusBackColor(string value, bool error)
        {
            ...
            if (value == "UPDATE_AVAILABLE" || value == "WORKING" || value == "INSTALLABLE_EXISTING_STATE") return Color.FromArgb(68, 49, 18);
        ...
        private static Color StatusColor(string value)
        {
            ...
            if (value == "UPDATE_AVAILABLE" || value == "WORKING" || value == "INSTALLABLE_EXISTING_STATE") return Warning;
