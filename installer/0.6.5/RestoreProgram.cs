...
namespace Ams2KoreanBeta
{
    internal sealed class RestoreForm : Form
    {
        ...
        public RestoreForm()
        {
            Text = "AMS2 Korean Patch Emergency Restore 0.6.5";
            ...
            Controls.Add(new Label { Text = "Closed Beta 0.6.5 Emergency Restore", Left = 20, Top = 18, Width = 560, Height = 30, Font = new Font("Malgun Gothic", 14F, FontStyle.Bold) });
