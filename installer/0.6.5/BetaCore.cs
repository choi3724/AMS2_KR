...
namespace Ams2KoreanBeta
{
    ...
    {
        public const string PackageId = "AMS2-KR-BETA-0.6.5-PRETENDARD";
        public const string Version = "Closed Beta 0.6.5";
    ...
    internal sealed class BetaEngine
    {
        ...
        public OperationResult Diagnose(GameInfo game, string outputZip)
        {
            try
            {
                Prepare(game);
                ValidateGame(game);
                string temp = Path.Combine(Path.GetTempPath(), "AMS2-KR-BETA065-DIAG-" + Guid.NewGuid().ToString("N"));
        ...
        private void PreflightFiles()
        {
            ...
            PackageManifest.RequireFile(PackageManifest.SafeJoin(gameDir, PackageManifest.IgphaseHudRelativePath),
                PackageManifest.IgphaseHudBytes, PackageManifest.IgphaseHudSourceSha256, "지원되는 원본 IGPHASEHUD.bff");
        }
        ...
        private InstallState BuildState(GameInfo game)
        {
            ...
            DirectState bffState = new DirectState {
                ...
                Action = "modified",
                BeforeSha = PackageManifest.IgphaseHudSourceSha256,
                BeforeBytes = PackageManifest.IgphaseHudBytes,
