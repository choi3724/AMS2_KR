...
namespace Ams2KoreanBeta
{
    internal sealed class InstallerForm : Form
    {
        ...
        {
            Text = "AMS2 Korean Patch Closed Beta 0.6.5";
            ...
            Label title = new Label { Text = "Automobilista 2 한국어 패치 — Closed Beta 0.6.5", Left = 20, Top = 18, Width = 780, Height = 30, Font = new Font("Malgun Gothic", 15F, FontStyle.Bold) };
    ...
    internal static class GithubUpdater
    {
        ...
        public static GithubReleaseInfo Check()
        {
            ...
            request.UserAgent = "AMS2-Korean-Patch-Updater/0.6.5";
