...
namespace Ams2KoreanBeta
{
    ...
    internal sealed class ErsArchivePatch
    {
        internal const string RelativePath = "Pakfiles\\HUDDISPLAY.bff";
        internal readonly string DeltaRelativePath, StockSha, PatchedSha;
        internal readonly int ArchiveBytes;

        internal ErsArchivePatch(bool legacy)
        {
            DeltaRelativePath = legacy ? "payload\\HUDDISPLAY.24132163.xor.gz" : "payload\\HUDDISPLAY.xor.gz";
            ArchiveBytes = legacy ? 23701335 : 24235863;
            StockSha = legacy ? "0673E7D678E1B4B2486867072BCEA0F1F11B1D571807A582AC85B91F2C9E37A2" : "401A819D78DC45E9555888AB96F7885B0737F2831C9B02EF0654746AB9F93E97";
            PatchedSha = legacy ? "F8A840F569D256DB4E1A67D73C5B2BB9CC4927E18109178B67356479BDCE81E5" : "AE07B378819414314952BE993C146C83AF85F327BCCC5F7C55323941B2A2FDBC";
        }

        internal void ValidatePackage(string releaseRoot)
        {
        ...
        internal void Prepare(string releaseRoot, string live, string candidate, string original)
        {
