...
namespace Ams2KoreanBeta
{
    ...
    internal sealed class InstallerForm : Form
    {
        ...
        public InstallerForm()
        {
            ...
            Text = "Automobilista 2 한국어 패치 — Closed Beta 0.6.86";
            Font = UiFont(9F);
        ...
        private Control BuildTitleBar()
        {
            ...
            Label title = new Label { Text = "Automobilista 2 한국어 패치 — Closed Beta 0.6.86", ForeColor = TextPrimary, Font = UiFont(10.5F), TextAlign = ContentAlignment.MiddleLeft, Location = new Point(49, 0), Size = new Size(720, 43) };
        ...
        private Control BuildFooter()
        {
            ...
            Label version = new Label { Text = "Automobilista 2 한국어 패치 — Closed Beta 0.6.86", ForeColor = Color.FromArgb(131, 118, 117), Font = UiFont(8.5F), TextAlign = ContentAlignment.MiddleRight, Anchor = AnchorStyles.Top | AnchorStyles.Right, Size = new Size(430, 37) };
        ...
        private void Run(string action)
        {
            ...
            {
                using (SaveFileDialog d = new SaveFileDialog()) { d.Filter = "ZIP 파일|*.zip"; d.FileName = "AMS2-Korean-Beta0686-Diagnostic-" + DateTime.Now.ToString("yyyyMMdd-HHmmss") + ".zip"; if (d.ShowDialog(this) != DialogResult.OK) return; diag = d.FileName; }
            }
    ...
    internal static class GithubUpdater
    {
        ...
        {
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12; HttpWebRequest request = (HttpWebRequest)WebRequest.Create(LatestReleaseApi); request.UserAgent = "AMS2-Korean-Patch-Updater/0.6.86"; request.Accept = "application/vnd.github+json"; request.Timeout = 6000; string json;
