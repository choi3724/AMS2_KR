...
namespace Ams2KoreanBeta
{
    internal sealed class RestoreForm : Form
    {
        ...
        public RestoreForm()
        {
            Text = "AMS2 한국어 패치 CB 0.6.87 — 긴급 원복";
            ...
            header.Controls.Add(new Label { Text = "CLOSED BETA 0.6.87", Left = 26, Top = 58, Width = 240, Height = 20, ForeColor = Color.FromArgb(190, 199, 214), Font = new Font("Segoe UI", 8.5F, FontStyle.Bold) });
            Controls.Add(header);
            ...
            restore.Text = "설치 직전 상태로 복원"; restore.SetBounds(24, 195, 190, 42); restore.FlatStyle = FlatStyle.Flat; restore.BackColor = Color.FromArgb(185, 28, 28); restore.ForeColor = Color.White; restore.Click += delegate { Run(); }; Controls.Add(restore);
